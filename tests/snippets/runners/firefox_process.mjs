 ...
 *
 * https://gitlab.com/eyeo/adblockplus/abp-snippets/-/tree/next/test/runners/firefox_process.js
 * except for:
...
const FIREFOX_VERSION = '65.0';

async function runScript(firefoxPath, script, scriptArgs) {
